...
export function createAvatarSheet(pixiLoader, sheetWidth, sheetHeight) {
  let avatarSheet = new PIXI.BaseTexture.from(
    pixiLoader.resources["avatar"].url
  );
  ...
  avatarSheet["walkNorth"] = [
    ...
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(0, 3 * sheetHeight, sheetWidth, sheetHeight)
    ),
  ];
  ...
  avatarSheet["standSouth"] = [
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(2 * sheetWidth, 0, sheetWidth, sheetHeight)
    ),
  ];
  avatarSheet["walkSouth"] = [
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(1 * sheetWidth, 0, sheetWidth, sheetHeight)
    ),
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(2 * sheetWidth, 0, sheetWidth, sheetHeight)
    ...
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(3 * sheetWidth, 0, sheetWidth, sheetHeight)
    ),
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(0, 0, sheetWidth, sheetHeight)
    ),
  ];
  ...
  avatarSheet["standWest"] = [
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(2 * sheetWidth, sheetHeight, sheetWidth, sheetHeight)
    ),
  ];
  avatarSheet["walkWest"] = [
    ...
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(0, 1 * sheetHeight, sheetWidth, sheetHeight)
    ),
  ];
  ...
  avatarSheet["walkEast"] = [
    ...
    new PIXI.Texture(
      avatarSheet,
      new PIXI.Rectangle(0, 2 * sheetHeight, sheetWidth, sheetHeight)
    ),
  ];
